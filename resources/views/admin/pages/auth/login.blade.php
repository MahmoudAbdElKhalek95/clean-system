                    ...
                    <div class="card-body">
                        ...
                        <form class="auth-login-form mt-2" action="{{ route('admin.postLogin') }}" method="POST">
                            ...
                            <div class="mb-1 @error('phone') is-invalid @enderror">
                                <label for="login-phone" class="form-label">{{ __('admin.phone') }}</label>
                                <input type="number" class="form-control" id="login-phone" name="phone" placeholder="" aria-describedby="login-phone" tabindex="1" autofocus value="{{ old('phone') }}" />
                                @error('phone')
