...
@section('title')
    <title>{{ config('app.name') }} | {{ __('admin.uncomplete_project_catgory') }}</title>
@endsection
@section('content')
            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="bold mb-0 mt-1 text-dark">
                        ...
                        <span>{{ __('admin.uncomplete_project_catgory') }}</span>
                    </h1>
                </div>
            </div>
        </div>
...
<script>
    ...
    var dt_ajax = dt_ajax_table.dataTable({
        ...
        ajax: {
            url: "{{ route('listUnCompleteCategory') }}",
            data: function (d) {
