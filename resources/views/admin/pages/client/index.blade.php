    ...
    <div class="content-header row">
        ...
        <div class="content-header-right text-md-end col-md-6 col-12 d-md-block ">
            <div class="mb-1 breadcrumb-right">
                <div class="dropdown">
                    <a class="btn btn-sm btn-outline-primary me-1 waves-effect" href="{{ route('client.create') }}">
                        <i data-feather="plus"></i>
                        <span class="active-sorting text-primary">{{ __('client.actions.create') }}</span>
                    </a>

                    @include('admin.pages.client.import')
            ...
            columnDefs: [
                {
                    ...
                    "render": function (data, client, row) {
                        ...
                        var editUrl = '{{ route("client.edit", ":id") }}';
                        editUrl = editUrl.replace(':id', row.id);

                        var deleteUrl = '{{ route("client.destroy", ":id") }}';
