    ...
    <div class="content-header row">
        ...
        <div class="content-header-right text-md-end col-md-6 col-12 d-md-block ">
            <div class="mb-1 breadcrumb-right">
                <div class="dropdown">
                    <a class="btn btn-sm btn-outline-primary me-1 waves-effect" href="{{ route('sections.create') }}">
        ...
        <div class="card">
            <div class="card-datatable table-responsive">
                <table class="dt-multilingual table datatables-ajax">
                    <thead>
                    <tr>
                        <th>{{ __('sections.name') }}</th>
                        <th>{{ __('sections.code') }}</th>
                        <th>{{ __('sections.type') }}</th>
            ...
            columnDefs: [
                {
                    ...
                    "render": function (data, type, row) {
                        var editUrl = '{{ route("sections.edit", ":id") }}';
                        editUrl = editUrl.replace(':id', row.id);
                        var deleteUrl = '{{ route("sections.destroy", ":id") }}';
