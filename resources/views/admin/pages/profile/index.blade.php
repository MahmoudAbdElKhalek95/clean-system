                ...
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                             <a class="bold text-dark" href="{{ route('profile.index') }}">{{ __('profile.profile') }}</a>
                        </li>
                        <li class="list-group-item">
                            <a class="bold text-dark" href="{{ route('profile.change_password') }}">{{ __('profile.change_password') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
