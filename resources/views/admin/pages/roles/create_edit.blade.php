    ...
    <form method='post' enctype="multipart/form-data"  id="jquery-val-form"
        ...
        <div class="content-body">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="mb-1 col-md-6  @error('display_name') is-invalid @enderror">
                        ...
                        <div class="mb-1 col-md-6  @error('name') is-invalid @enderror">
                            <label class="form-label">{{ __('roles.enname') }}</label>
                                ...
                                <div>
                                    @foreach($group as $permission)
                                        <div class="form-check">
                                                <?php
                                                $checked= (in_array($permission->id, $itemPermissions))?'checked':'';?>
