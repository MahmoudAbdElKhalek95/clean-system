            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @for( $count = 1 ; $count <= $item->var_number ; $count++ )

                        <div  style=" display:{{ empty($item ) ? 'none' :'block'}} " id ="var{{$count}}"  class="mb-1 col-md-4  @error('var') is-invalid @enderror">
                            <label class="form-label" for="var"> المتغير {{$count}}  </label>
                            <select name="param[]"   id ="var11" class="form-control  extra_field"
                                      >

                                {{--  <option value="" selected> اختر  </option>  --}}
                                <option value="null">اختر  </option>
                                <option value="project_name" {{ ($count == 1 && $param1 == 'project_name')|| ($count == 2 && $param2 == 'project_name') || ($count == 3 && $param3 == 'project_name')   ? 'selected' : '' }} > {{ __('sending_templates.project_name') }}  </option>
                                <option value="project_link"    {{ ($count == 1 && $param1 == 'project_link')|| ($count == 2 && $param2 == 'project_link') || ($count == 3 && $param3 == 'project_link')   ? 'selected' : '' }} > {{ __('sending_templates.project_link') }}  </option>
                                <option value="project_percent"   {{ ($count == 1 && $param1 == 'project_percent')|| ($count == 2 && $param2 == 'project_percent') || ($count == 3 && $param3 == 'project_percent')   ? 'selected' : '' }} >   نسبه المشروع الحالي  </option>
                                <option value="remain_project_percent"  {{ ($count == 1 && $param1 == 'remain_project_percent')|| ($count == 2 && $param2 == 'remain_project_percent') || ($count == 3 && $param3 == 'remain_project_percent')   ? 'selected' : '' }} >  نسبه المشروع المتبقي  </option>
