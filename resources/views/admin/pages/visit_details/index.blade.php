            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="bold mb-0 mt-1 text-dark">
                        ...
                        <span>{{ __('visit_details.plural') }}</span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="card-datatable table-responsive">
                <table class="dt-multilingual table datatables-ajax">
                    ...
                    <tr>
                        ...
                        <th>{{ __('visit_details.rate') }}</th>


                        <th width="15%" class="text-center">{{ __('visit_details.options') }}</th>
                    </tr>
                    </thead>
                </table>
            </div>
            ...
            columnDefs: [
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        var editUrl = '{{ route("visit_details.edit", ":id") }}';
                        editUrl = editUrl.replace(':id', row.id);

                        var deleteUrl = '{{ route("visit_details.destroy", ":id") }}';
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <i data-feather="edit-2" class="font-medium-2"></i>
                                        <span>{{ __('visit_details.actions.edit') }}</span>
                                    </a>
                                    <a class="dropdown-item delete_item" data-url="`+deleteUrl+`" href="#">
                                        <i data-feather="trash" class="font-medium-2"></i>
                                            <span>{{ __('visit_details.actions.delete') }}</span>
                                    </a>
                                </div>
                            </div>
                            `;
